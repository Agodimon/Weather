...
data class CityModel(
    ...
    companion object {
        ...
        fun getDefaultCity(): CityModel = CityModel("Москва", 55.755826, 37.617299900000035)

        fun getWorldCities(): List<WeatherModel> = listOf(
        ...
        fun getRussianCities(): List<WeatherModel> = listOf(
